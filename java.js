//console.log(`js is app and running.....`)
...
/* button.addEventListener("add", () => {
  console.log("Design a new grid")
}) */
window.addEventListener("resize", () => initializeDrawArea(16, sketchPad))
button.addEventListener("click", () => sizeGridSquares(sketchPad))
...
initializeDrawArea(16, sketchPad)
...
//designing the color pencil fill
function colorIn() {
